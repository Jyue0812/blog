...
```mysql
select 字段 from 表名 [where 条件] [group by 分组][having 条件][order by 排序 asc|desc][limit限制 s,n]
```
...
insert into stuinfo values(null,'小舒',2,18,'东北'),(null,'小京',1,20,'北京'),(null,'小强',1,22,'北京'),(null,'小力',1,20,'天津'),(null,'小丽',2,21,'重庆'),(null,'小芳',2,20,'天津');
...
insert into stuinfo values(13,'小月','male',18,'重庆') on duplicate key update sname='小月',sex=2;
```
